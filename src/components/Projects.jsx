...
<section className=' h-[30vh]  sm:h-[50vh]   flex  flex-wrap flex-cols-1 md:flex-cols-8 md:flex-flow-row  text-white mt-20 md:mt-0  justify-center items-center'>
     ...
     <div className=' md:col-span-3  flex  flex-col items-center justify-center p-4 gap-3 max-w-auto sm:max-w-auto md:max-w-[800px] m-auto '> 
        ...
        <h1 className='text-2xl sm:text-3xl  md:text-5xl font-bold text-center ' > <span className='text-primary p-2'> Mi trabajo, </span> mis proyectos están basados ​​en React js y uso APIs para obtener información</h1>
...
<div className=' md:col-span-4  flex  flex-col items-center justify-center p-4 gap-3 max-w-auto sm:max-w-auto md:max-w-[400px]  '> 
    ...
    <p className='text-xls'> </p>
        ...
        <i className='bx bxl-tailwind-css text-primary  ' ></i>
         ...
         <button  onClick={handleClickPokemon}   className=' text-white text-xl py-2 px-10 rounded-full border-2  border-white   hover:bg-cyan-600 '>ir al proyecto </button>        
...
<div className=' md:col-span-4  flex  flex-col items-center justify-center p-4 gap-3 max-w-auto sm:max-w-auto md:max-w-[400px]  '> 
    ...
    <section className=' text-white text-xl py-2 px-10 rounded-full gap'> 
        ...
        <i className='bx bxl-html5 text-[#f06529]  '></i> 
         ...
         <button onClick={handleClickCart}  className=' text-white text-xl py-2 px-10 rounded-full border-2  border-white  hover:bg-cyan-600'> ir al proyecto </button> 
