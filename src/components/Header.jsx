...
const [showMenu, setShowMenu] = useState(false)
  return (
    ...
    <div className='xl:w-1/3 text-center align-middle -mt-4 '>
        <a href='#' className=' font-[Inconsolata:wght@300]  relative p-1 text-primary  text-sm sm:text-lg md:text-2xl  ' > 
            Jeal Aragon 
    ...
    <nav 
    className={`fixed  h-1/2  md:w-[40%] xl:w-1/3 w-full  ${showMenu? "top-0": "-top-full" } top-0 xl:static flex-1  flex flex-col xl:flex-row items-center justify-end sm:justify-center gap-5  transition-all duration-500 bg-secundary p-20 border-b-4 border-b-primary sm:border-none `}>
